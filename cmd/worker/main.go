...
func (w *workerImpl) CallStream(ctx context.Context, methodName string, inputJSON []byte, rawCollectionMode bamlutils.RawCollectionMode) (<-chan *workerplugin.StreamResult, error) {
	...
	adapter.SetRawCollectionMode(rawCollectionMode)
