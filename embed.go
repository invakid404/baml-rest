...
//go:embed LICENSE NOTICE RELEASE.md adapter.go adapters cmd/build cmd/embed cmd/hacks/hacks/astutil.go cmd/hacks/hacks/context_fix.go cmd/hacks/hacks/dynamic_order_client.go cmd/hacks/hacks/dynamic_order_fix.go cmd/hacks/hacks/generated_client_rewrite.go cmd/hacks/hacks/hack.go cmd/hacks/hacks/lazy_runtime.go cmd/hacks/hacks/patched_module.go cmd/hacks/hacks/patches cmd/hacks/hacks/runtime_deadlock_fix.go cmd/hacks/hacks/serde_nil_fix.go cmd/hacks/main.go cmd/introspect/main.go cmd/regenerate-dynclient cmd/schema/main.go cmd/serve/config.go cmd/serve/debug.go cmd/serve/debug_stub.go cmd/serve/error.go cmd/serve/headers.go cmd/serve/main.go cmd/serve/openapi.json cmd/serve/streamwriter.go cmd/serve/unary.go cmd/serve/unary_handlers.go cmd/serve/unary_stub.go cmd/serve/worker cmd/serve/worker_mode.go cmd/serve/worker_mode_inprocess.go cmd/serve/worker_mode_subprocess.go cmd/verify-adapter-pins cmd/verify-framework-adapter/main.go cmd/worker embed.go go.mod go.sum go.work go.work.sum internal/apierror/error.go internal/httplogger internal/memlimit/memlimit.go internal/rootruntime internal/unsafeutil renovate.json scripts
var source embed.FS
