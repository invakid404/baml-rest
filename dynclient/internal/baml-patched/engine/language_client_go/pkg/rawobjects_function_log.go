...
import (
	...
	"github.com/invakid404/baml-rest/dynclient/internal/baml-patched/engine/language_client_go/baml_go/raw_objects"
...
func newFunctionLog(ptr int64, rt unsafe.Pointer) FunctionLog {
