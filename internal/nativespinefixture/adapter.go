...
// fixtureAdapter is a pure-Go bamlutils.Adapter for the M1 native runtime
// fixture. It stores only the stream mode (which the generated closure reads to
// admit/decline a mode) and the handful of fields worker.Handler.CallStream /
...
// without the CFFI-bound generated BamlAdapter. Modeled on the worker package's
// own fakeAdapter.
...
// SetDeBAMLRenderer satisfies the worker's optional deBAMLRendererSetter
// interface so configureAdapter installs its callback here harmlessly.
