...
//
// RIGHT NOW they are MASTER-DURABLE: all five name 8fe27577082c, the U1b MASTER squash-merge
// commit (PR #711) that carries the ExecBridge-U1b guarded-tree change. nanollmprepare
...
// the U1b native-only source (nativeserve/spine's NewWorkerRuntime factory + nanollmprepare's
// nativeonlyboot / cmd/worker-nativeonly). So nativeserve/pin_followup.md reads STATUS:
// RESOLVED and the post-squash re-pin to the U1b master squash commit is PERFORMED (the pins
// were briefly branch-only at 9a67ca3741a7 pre-merge). Do not treat this
