...
// Package opeq is the LIVE socket proof for the `==` half of the de-BAML Slice
...
//
// This package therefore links EXACTLY ONE generated client: the isolated `eq`
// project, which declares the two pinned names once with `{{ this == 0 }}` and bakes
// its own loopback port (17658) so it can run beside the others.
//
...
import (
	...
	fixturebaml "github.com/invakid404/baml-rest/internal/nativeprompt/testdata/staticserve_op_fixtures/eq/baml_client"
	fixture "github.com/invakid404/baml-rest/internal/nativeprompt/testdata/staticserve_op_fixtures/eq/generated"
...
const loopbackAddr = "127.0.0.1:17658"
