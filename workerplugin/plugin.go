...
type Worker interface {
	...
	Call(ctx context.Context, methodName string, inputJSON, optionsJSON []byte) (*CallResult, error)

	// CallStream executes a BAML method and streams results
	CallStream(ctx context.Context, methodName string, inputJSON, optionsJSON []byte) (<-chan *StreamResult, error)
