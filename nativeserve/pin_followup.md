...
`23d7dbdc59af` on `feat/debaml-m3e-a`, the branch SOURCE commit that carries the M3e-A
...
```text
STATUS: OUTSTANDING
PINNED-COMMIT: 23d7dbdc59af
PINNED-STAMP: 20260904103402
...
`23d7dbdc59af` is the branch commit that carries the guarded-tree change. The packaged
...
| --- | --- | --- | --- |
| 1 | `nativeserve/go.mod` | `github.com/invakid404/baml-rest` | `v0.0.0-20260904103402-23d7dbdc59af` |
| 2 | `nativeserve/go.mod` | `github.com/invakid404/baml-rest/bamlutils` | `v0.0.49-0.20260904103402-23d7dbdc59af` |
| 3 | `nativeserve/go.mod` | `github.com/invakid404/baml-rest/worker` | `v0.0.49-0.20260904103402-23d7dbdc59af` |
| 4 | `internal/nativebody/nanollmprepare/go.mod` | `github.com/invakid404/baml-rest/bamlutils` | `v0.0.49-0.20260904103402-23d7dbdc59af` |
| 5 | `internal/nativebody/nanollmprepare/go.mod` | `github.com/invakid404/baml-rest/worker` | `v0.0.49-0.20260904103402-23d7dbdc59af` |
...
1. **All five selections re-pointed together** to `23d7dbdc59af` (Go-formula stamp
   `20260904103402`). The edit touched only `require` lines; `nanollmprepare`'s
...
3. **Both mirrored narratives rewritten** to BRANCH-ONLY naming the M3e-A branch source
   commit `23d7dbdc59af`, with the U1c master `56d5473a1bdb` sentences demoted to
   HISTORICAL.
...
**This is NOT yet done for M3e-A: the pins are BRANCH-ONLY** at `23d7dbdc59af`. What
...
- [x] point all five selections at the M3e-A SOURCE commit `23d7dbdc59af` (Go-formula
      stamp `20260904103402`), each with its correct base version
...
- [ ] rewrite both narratives to master-durable naming the master squash commit; demote
      the branch-only `23d7dbdc59af` text to `HISTORICAL, SUPERSEDED`
