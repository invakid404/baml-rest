...
`e74ed12a5be5` on `feat/debaml-m3e-a`, the branch SOURCE commit that carries the M3e-A
...
```text
STATUS: OUTSTANDING
PINNED-COMMIT: e74ed12a5be5
PINNED-STAMP: 20260904104337
...
`e74ed12a5be5` is the branch commit that carries the guarded-tree change. The packaged
...
| --- | --- | --- | --- |
| 1 | `nativeserve/go.mod` | `github.com/invakid404/baml-rest` | `v0.0.0-20260904104337-e74ed12a5be5` |
| 2 | `nativeserve/go.mod` | `github.com/invakid404/baml-rest/bamlutils` | `v0.0.49-0.20260904104337-e74ed12a5be5` |
| 3 | `nativeserve/go.mod` | `github.com/invakid404/baml-rest/worker` | `v0.0.49-0.20260904104337-e74ed12a5be5` |
| 4 | `internal/nativebody/nanollmprepare/go.mod` | `github.com/invakid404/baml-rest/bamlutils` | `v0.0.49-0.20260904104337-e74ed12a5be5` |
| 5 | `internal/nativebody/nanollmprepare/go.mod` | `github.com/invakid404/baml-rest/worker` | `v0.0.49-0.20260904104337-e74ed12a5be5` |
...
1. **All five selections re-pointed together** to `e74ed12a5be5` (Go-formula stamp
   `20260904104337`). The edit touched only `require` lines; `nanollmprepare`'s
...
3. **Both mirrored narratives rewritten** to BRANCH-ONLY naming the M3e-A branch source
   commit `e74ed12a5be5`, with the U1c master `56d5473a1bdb` sentences demoted to
   HISTORICAL.
...
**This is NOT yet done for M3e-A: the pins are BRANCH-ONLY** at `e74ed12a5be5`. What
...
- [x] point all five selections at the M3e-A SOURCE commit `e74ed12a5be5` (Go-formula
      stamp `20260904104337`), each with its correct base version
...
- [ ] rewrite both narratives to master-durable naming the master squash commit; demote
      the branch-only `e74ed12a5be5` text to `HISTORICAL, SUPERSEDED`
