...
`7da8ea40ed07` on `feat/debaml-m3e-a`, the branch SOURCE commit that carries the M3e-A
...
```text
STATUS: OUTSTANDING
PINNED-COMMIT: 7da8ea40ed07
PINNED-STAMP: 20260904112736
...
`7da8ea40ed07` is the branch commit that carries the guarded-tree change. The packaged
...
| --- | --- | --- | --- |
| 1 | `nativeserve/go.mod` | `github.com/invakid404/baml-rest` | `v0.0.0-20260904112736-7da8ea40ed07` |
| 2 | `nativeserve/go.mod` | `github.com/invakid404/baml-rest/bamlutils` | `v0.0.49-0.20260904112736-7da8ea40ed07` |
| 3 | `nativeserve/go.mod` | `github.com/invakid404/baml-rest/worker` | `v0.0.49-0.20260904112736-7da8ea40ed07` |
| 4 | `internal/nativebody/nanollmprepare/go.mod` | `github.com/invakid404/baml-rest/bamlutils` | `v0.0.49-0.20260904112736-7da8ea40ed07` |
| 5 | `internal/nativebody/nanollmprepare/go.mod` | `github.com/invakid404/baml-rest/worker` | `v0.0.49-0.20260904112736-7da8ea40ed07` |
...
1. **All five selections re-pointed together** to `7da8ea40ed07` (Go-formula stamp
   `20260904112736`). The edit touched only `require` lines; `nanollmprepare`'s
...
3. **Both mirrored narratives rewritten** to BRANCH-ONLY naming the M3e-A branch source
   commit `7da8ea40ed07`, with the U1c master `56d5473a1bdb` sentences demoted to
   HISTORICAL.
...
**This is NOT yet done for M3e-A: the pins are BRANCH-ONLY** at `7da8ea40ed07`. What
...
- [x] point all five selections at the M3e-A SOURCE commit `7da8ea40ed07` (Go-formula
      stamp `20260904112736`), each with its correct base version
...
- [ ] rewrite both narratives to master-durable naming the master squash commit; demote
      the branch-only `7da8ea40ed07` text to `HISTORICAL, SUPERSEDED`
